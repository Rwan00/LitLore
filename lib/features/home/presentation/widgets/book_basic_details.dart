...
class BookBasicDetails extends StatelessWidget {
  const BookBasicDetails({super.key, required this.book});
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: List.generate(book.volumeInfo?.categories?.length ?? 0, (
              index,
            ) {
              return GestureDetector(
                onTap: () {
                  context.push(
                    CategoryBooksView.routeName,
                    extra: {"title": book.volumeInfo?.categories?[index]},
                  );
                },
                child: Padding(
